...
### Fixed
- Fixed WayForPay API documentation link in README (now points to https://wiki.wayforpay.com/en/)
- Removed non-existent Discussions link from Support section
- Removed emoji characters from README for better compatibility
- Corrected author name to Oleksii Kruhlyk

### Changed
- Improved Support section formatting in README
